                            ...
                            <form action="" method="">
                                ...
                                <div className="wizard-navigation">
                                    <ul className='nav nav-pills'>
                                        <li className='col-sm-4'><a href="#about" data-toggle="tab">About</a></li>
                                        <li className='col-sm-4'><a href="#account" data-toggle="tab">Account</a></li>
                                        <li className='col-sm-4'><a href="#address" data-toggle="tab">Address</a></li>
                                    </ul>
                                </div>
                                      ...
                                      <div className="row">
                                            ...
                                            <div className="col-sm-6">
                                                <div className="input-group">
                                                    ...
                                                    <div className="form-group label-floating">
                                                      <label className="control-label">First Name <small>(required)</small></label>
                                                ...
                                                <div className="input-group">
                                                    ...
                                                    <div className="form-group label-floating">
                                                      <label className="control-label">Last Name <small>(required)</small></label>
                                            ...
                                            <div className="col-sm-10 col-sm-offset-1">
                                                <div className="input-group">
                                                    ...
                                                    <div className="form-group label-floating">
                                                        <label className="control-label">Email <small>(required)</small></label>
                                ...
                                <div className="wizard-footer">
                                    <div className="pull-right">
                                        ...
                                        <input type='button' className='btn btn-finish btn-fill btn-success btn-wd' name='finish' value='Finish' />
                                    </div>
